...
public class MaterialLeanBack extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        addView(LayoutInflater.from(getContext()).inflate(R.layout.mlb_layout, this, false));//ici

        imageBackground = (ImageView) findViewById(R.id.mlb_imageBackground);//ici
        imageBackgroundOverlay = findViewById(R.id.mlb_imageBackgroundOverlay);//ici
        ...
        recyclerView = (RecyclerView) findViewById(R.id.mlb_recyclerView);//ici
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
    }

    public MaterialLeanBack.Adapter getAdapter() {
        return adapter;
    }

    public void setAdapter(MaterialLeanBack.Adapter adapter) {
    ...
    public MaterialLeanBack.Customizer getCustomizer() {
        return customizer;
    }

    public void setCustomizer(MaterialLeanBack.Customizer customizer) {
