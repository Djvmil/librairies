package com.djamil.suntelecom.librairies.takephoto
...
import com.djamil.suntelecom.librairies.R
import com.djamil.suntelecom.librairies.takephoto.util.FileUtil
import com.djamil.suntelecom.librairies.takephoto.util.IntentUtil
...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val GITHUB_REPOSITORY = "https://github.com/djamil/ImagePicker"
    ...
    fun pickCameraImage(view: View) {
        TakePhoto.with(this)
            ...
            .launch(CAMERA_IMAGE_REQ_CODE)
    }

    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        super.onActivityResult(requestCode, resultCode, data)
        if (resultCode == Activity.RESULT_OK) {
            Log.e("TAG", "Path:${TakePhoto.getFilePath(data)}")
            // File object will not be null for RESULT_OK
            val file = TakePhoto.getFile(data)!!
            when (requestCode) {
        ...
        } else if (resultCode == TakePhoto.RESULT_ERROR) {
            Toast.makeText(this, TakePhoto.getError(data), Toast.LENGTH_SHORT).show()
        } else {
