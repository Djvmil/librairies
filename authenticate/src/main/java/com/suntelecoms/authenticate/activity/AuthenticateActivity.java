...
import com.suntelecoms.authenticate.andrognito.pinlockview.IndicatorDots;
import com.suntelecoms.authenticate.andrognito.pinlockview.PinLockListener;
import com.suntelecoms.authenticate.andrognito.pinlockview.PinLockView;
...
import com.suntelecoms.authenticate.util.Animate;
import com.suntelecoms.authenticate.util.Utils;
    ...
    private void checkForFingerPrint() {
        ...
        final FingerPrintListener fingerPrintListener = new FingerPrintListener() {
            ...
            public void onError(CharSequence errorString) {
                Toast.makeText(AuthenticateActivity.this, errorString, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onHelp(CharSequence helpString) {
                Toast.makeText(AuthenticateActivity.this, helpString, Toast.LENGTH_SHORT).show();
            }
