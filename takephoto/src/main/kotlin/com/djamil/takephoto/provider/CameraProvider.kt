...
import com.djamil.takephoto.util.IntentUtils
import com.djamil.takephoto.util.PermissionUtil
import com.djamil.takephoto.util.PermissionUtil.isPermissionGranted
import java.io.File

/**
 * @ref https://github.com/Dhaval2404/ImagePicker
 */
class CameraProvider(activity: TakePhotoActivity) : BaseProvider(activity) {
     ...
     *   Ref: https://github.com/djamil/ImagePicker/issues/34
     */
