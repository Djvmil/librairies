 ...
 */
class CropProvider(activity: TakePhotoActivity) : BaseProvider(activity) {
    ...
    init {
        ...
        mCrop = bundle.getBoolean(TakePhoto.EXTRA_CROP, false)
        mCropAspectX = bundle.getFloat(TakePhoto.EXTRA_CROP_X, 0f)
        mCropAspectY = bundle.getFloat(TakePhoto.EXTRA_CROP_Y, 0f)
