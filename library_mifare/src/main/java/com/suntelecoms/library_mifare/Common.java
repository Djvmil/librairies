...
import static com.suntelecoms.library_mifare.Activities.Preferences.Preference.AutoCopyUID;
import static com.suntelecoms.library_mifare.Activities.Preferences.Preference.UIDFormat;
...
public class Common extends MultiDexApplication {
    ...
    private static List<String> listSecretKeys;
    private static Context context;
    private CynodMsg cynodMsg;
    ...
    private static final String LOG_TAG = com.suntelecoms.library_mifare.Common.class.getSimpleName();
     ...
     * {@link "KeyMapCreator"}
     * @see "KeyMapCreator"
     * @see com.suntelecoms.library_mifare.MCReader#getKeyMap()
     */
...
// ############################################################################
    ...
    public void onCreate() {
        ...
        Log.i(LOG_TAG, "Common.onCreate() : "+mAppContext.getPackageName());
        mScale = getResources().getDisplayMetrics().density;

        try {
            mVersionCode = getPackageManager().getPackageInfo(getPackageName(), 0).versionName;
            com.suntelecoms.library_mifare.Common.context = getApplicationContext();
    ...
    public static File getFileFromStorage(String relativePath) {
        File file;
        boolean isUseInternalStorage = getPreferences().getBoolean(UseInternalStorage.toString(), false);
     ...
     */
    public enum NfcPreference {
        NFC_ENABLED("NFC_ENABLED"),
        NFC_CONFIG_REQUIRED("NFC_CONFIG_REQUIRED");
        // Add more preferences here (comma separated).

        private final String code;

        private NfcPreference(final String code) {
            this.code = code;
        }
    ...
    public static boolean setPreferenceBoolean(String prefName, boolean val){
        SharedPreferences.Editor edit = com.suntelecoms.library_mifare.Common.getPreferences().edit();
        edit.putBoolean(prefName, val);
        edit.apply();
        return edit.commit();
    }
     ...
     * by {@link com.suntelecoms.library_mifare.MCReader#patchTag(Tag)} and  {@link #mTag} as well as
    ...
    public static int treatAsNewTag(Intent intent, Context context) {
        ...
        if (NfcAdapter.ACTION_TECH_DISCOVERED.equals(intent.getAction())) {
            ...
            tag = com.suntelecoms.library_mifare.MCReader.patchTag(tag);
            setTag(tag);
    ...
    public static boolean openApp(Context context, String packageName) {
        ...
        try {
            Log.d(LOG_TAG, "openApp => TRUE, packageName => "+packageName);
            ...
            Log.d(LOG_TAG, "openApp => FALSE, causes : "+e.getLocalizedMessage());
            return false;
        }
    }
    ...
    public static boolean hasExternalNfcInstalled(Context context) {
        return com.suntelecoms.library_mifare.Common.isAppInstalled("eu.dedb.nfc.service", context);
    }
    ...
    /**
     * Create a connected {@link com.suntelecoms.library_mifare.MCReader} if there is a present MIFARE Classic
     * tag. If there is no MIFARE Classic tag an error
     * message will be displayed to the user.
     * @param context The Context in which the error Toast will be shown.
     * @return A connected {@link com.suntelecoms.library_mifare.MCReader} or "null" if no tag was present.
     */
    public static com.suntelecoms.library_mifare.MCReader checkForTagAndCreateReader(Context context) {
        com.suntelecoms.library_mifare.MCReader reader;
        boolean tagLost = false;
        // Check for tag.
        if (mTag != null && (reader = com.suntelecoms.library_mifare.MCReader.get(mTag)) != null) {
            Log.d(LOG_TAG, "checkForTagAndCreateReader() mTag NOT NULL == "+new String(mTag.getId()));
            try {
                reader.connect();
            } catch (Exception e) {
                tagLost = true;
            ...
            Log.d(LOG_TAG, "checkForTagAndCreateReader() mTag == NULL");
        }

        // Error. The tag is gone.
        //Toast.makeText(context, R.string.info_no_tag_found,Toast.LENGTH_LONG).show();
        Log.e(LOG_TAG, context.getString(R.string.info_no_tag_found)) ;
        return null;
    }
    ...
    public static boolean isValueBlock(String hexString) {
        byte[] b = com.suntelecoms.library_mifare.Common.hexStringToByteArray(hexString);
        if (b.length == 16) {
     ...
     * {@link "KeyMapCreator"}.
     * @return A key map (see {@link com.suntelecoms.library_mifare.MCReader#getKeyMap()}).
     */
    ...
    /**
     * Set the key map.
     * @param value A key map (see {@link com.suntelecoms.library_mifare.MCReader#getKeyMap()}).
     */
    ...
    //public static final String STD_KEYS = "std.keys";
    public static final String STD_KEYS_DIR ="stdkeys";
    public static final String DEFAULT_BO_KEYS_DIR = "defaultbo";
    public static final boolean IS_KEYS_DIR_PRIVATE = true;
    //public static final String TMP_DIR = "/tmp";
    ...
    public static List<String> getListSecretKeys() {
        return listSecretKeys;
    }

    public static void setListSecretKeys(List<String> listSecretKeys) {
        com.suntelecoms.library_mifare.Common.listSecretKeys = listSecretKeys;
    }

    public static Context getAppContext() {
        return com.suntelecoms.library_mifare.Common.context;
    }

    public CynodMsg getCynodMsg() {
        return cynodMsg;
    }

    public void setCynodMsg(CynodMsg cynodMsg) {
        this.cynodMsg = cynodMsg;
    }
