...
public class KeyboardDynamic {
     ...
     */
    public static void showKeyBoard(Context ctx, ViewGroup view, EditText editText, Boolean isShuffle, int colorKey){
        view.removeAllViews();
        ...
        KeyBoardAdapter keyBoardAdapter = new KeyBoardAdapter(ctx, editText, isShuffle, colorKey);
