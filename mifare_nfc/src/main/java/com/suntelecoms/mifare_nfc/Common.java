...
import com.suntelecoms.mifare_nfc.Activities.IActivityThatReactsToSave;

import static com.suntelecoms.mifare_nfc.Activities.Preferences.Preference.AutoCopyUID;
import static com.suntelecoms.mifare_nfc.Activities.Preferences.Preference.UIDFormat;
 ...
 */
public class Common extends androidx.multidex.MultiDexApplication {
     ...
     * the main activity
     * ({@link com.suntelecoms.mifare_nfc.Activities.MainMenu}).
     * (sub directory of {@link #HOME_DIR}.)
     */
    ...
    private static final String LOG_TAG = com.suntelecoms.mifare_nfc.Common.class.getSimpleName();
     ...
     * @see com.suntelecoms.mifare_nfc.Activities.KeyMapCreator
     ...
     * {@link com.suntelecoms.mifare_nfc.Activities.KeyMapCreator} started to
     * create a key map.
     * @see com.suntelecoms.mifare_nfc.Activities.KeyMapCreator
     * @see MCReader#getKeyMap()
     */
    ...
    /**
     * Global storage for the point where
     * {@link com.suntelecoms.mifare_nfc.Activities.KeyMapCreator} ended to
     * create a key map.
     * @see com.suntelecoms.mifare_nfc.Activities.KeyMapCreator
     * @see MCReader#getKeyMap()
     */
...
// ############################################################################
    ...
    public static void checkFileExistenceAndSave(final File file,
        ...
        if (file.exists()) {
            ...
            .setPositiveButton(R.string.action_replace,
                    (dialog, which) -> {
                        // Replace.
                        if (com.suntelecoms.mifare_nfc.Common.saveFile(file, lines, false)) {
    ...
    public static boolean hasExternalNfcInstalled(Context context) {
        return com.suntelecoms.mifare_nfc.Common.isAppInstalled("eu.dedb.nfc.service", context);
    }
    ...
    public static boolean isValueBlock(String hexString) {
        byte[] b = com.suntelecoms.mifare_nfc.Common.hexStringToByteArray(hexString);
        if (b.length == 16) {
     ...
     * The {@link com.suntelecoms.mifare_nfc.Activities.KeyMapCreator} will do
