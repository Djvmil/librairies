...
public class Preferences extends BasicActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_activity_preferences);
    ...
    private int getUIDFormatSequence() {
        int checkedRadioButtonId = mUIDFormatRadioGroup.getCheckedRadioButtonId();
        if (checkedRadioButtonId == R.id.radioButtonHex) {
            return 0;
        } else if (checkedRadioButtonId == R.id.radioButtonDecBE) {
            return 1;
        } else if (checkedRadioButtonId == R.id.radioButtonDecLE) {
            return 2;
        }
        return 0;
    }
