...
import com.suntelecoms.mifare_nfc.MCDiffUtils;
...
public class DiffTool extends BasicActivity {
    ...
    public final static String EXTRA_DUMP =
            "com.suntelecoms.mifare_nfc.Activity.DUMP";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_activity_diff_tool);
     ...
     * @see com.suntelecoms.mifare_nfc.MCDiffUtils#diffIndices(SparseArray, SparseArray)
     */
                ...
                for (int block = 0; block < blocks.length; block++) {
                    ...
                    RelativeLayout rl = (RelativeLayout)
                            getLayoutInflater().inflate(
                                    R.layout.test_list_item_diff_block,
                                    findViewById(
