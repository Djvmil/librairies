...
public class MainMenu extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_activity_main_menu_nfctest);
    ...
    public void onNewIntent(Intent intent) {
        if(Common.getPendingComponentName() != null) {
            Log.e(LOG_TAG, "onNewIntent: Common.getPendingComponentName " );
            intent.setComponent(Common.getPendingComponentName());
            startActivity(intent);

        } else {
            int typeCheck = Common.treatAsNewTag(intent, this);
            Log.e(LOG_TAG, "onNewIntent:Common.treatAsNewTag" );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.menuMainPreferences) {
            onShowPreferences();
            return true;
        } else if (itemId == R.id.menuMainAbout) {
            onShowAboutDialog();
            return true;
        }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.menuMainTagInfo) {
            ...
            startActivity(intent);
            return true;
        } else if (itemId == R.id.menuMainValueBlockTool) {
            intent = new Intent(this, ValueBlockTool.class);
            startActivity(intent);
            return true;
        } else if (itemId == R.id.menuMainAccessConditionTool) {
            intent = new Intent(this, AccessConditionTool.class);
            startActivity(intent);
            return true;
        } else if (itemId == R.id.menuMainDiffTool) {
            intent = new Intent(this, DiffTool.class);
            startActivity(intent);
            return true;
        } else if (itemId == R.id.menuMainBccTool) {
