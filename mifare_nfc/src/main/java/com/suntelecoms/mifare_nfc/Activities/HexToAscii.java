...
public class HexToAscii extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_activity_hex_to_ascii);
            ...
            if (dump.length != 0) {
                ...
                for (String line : dump) {
                    if (line.startsWith("+")) {
                        ...
                        ascii = TextUtils.concat(ascii, com.suntelecoms.mifare_nfc.Common.colorString(
                        ...
                        byte[] hex = com.suntelecoms.mifare_nfc.Common.hexStringToByteArray(line);
