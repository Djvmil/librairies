...
import com.suntelecoms.mifare_nfc.Activities.Preferences.Preference;
import com.suntelecoms.mifare_nfc.Common;
import com.suntelecoms.mifare_nfc.MCReader;
import com.suntelecoms.mifare_nfc.R;

import static com.suntelecoms.mifare_nfc.Activities.Preferences.Preference.UseInternalStorage;
 ...
 * retrieved by calling {@link com.suntelecoms.mifare_nfc.Common#getKeyMap()}.</li>
...
public class KeyMapCreator extends BasicActivity {
    ...
    public final static String EXTRA_KEYS_DIR =
            "com.suntelecoms.mifare_nfc.Activity.KEYS_DIR";
    ...
    public final static String EXTRA_SECTOR_CHOOSER =
            "com.suntelecoms.mifare_nfc.Activity.SECTOR_CHOOSER";
    /**
...
//            "com.suntelecoms.mifare_nfc.Activity.KEY_MAP";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_activity_create_key_map);
     ...
     * @see com.suntelecoms.mifare_nfc.Common#disableNfcForegroundDispatch(Activity)
     */
    @Override
    public void onPause() {
        super.onPause();
    ...
    public void onStart() {
        ...
        if (! com.suntelecoms.mifare_nfc.Common.getPreferences().getBoolean(UseInternalStorage.toString(),
                false) && ! com.suntelecoms.mifare_nfc.Common.isExternalStorageWritableErrorToast(this)) {
            setResult(3);
            finish();
            return;
        }
        ...
        // setting is active).
        boolean selectLastUsedKeyFiles = com.suntelecoms.mifare_nfc.Common.getPreferences().getBoolean(
    ...
    /**
     * Inform the worker thread from {@link #createKeyMap(com.suntelecoms.mifare_nfc.MCReader, Context)}
     ...
     * @see #createKeyMap(com.suntelecoms.mifare_nfc.MCReader, Context)
     */
     ...
     * {@link com.suntelecoms.mifare_nfc.Common#setKeyMap(android.util.SparseArray)}.
     * For doing so it uses other methods (
     * {@link #createKeyMap(com.suntelecoms.mifare_nfc.MCReader, Context)},
     * {@link #keyMapCreated(com.suntelecoms.mifare_nfc.MCReader)}).
     ...
     * @see #createKeyMap(com.suntelecoms.mifare_nfc.MCReader, Context)
     * @see #keyMapCreated(com.suntelecoms.mifare_nfc.MCReader)
     */
    public void onCreateKeyMap(View view) {
        boolean saveLastUsedKeyFiles = com.suntelecoms.mifare_nfc.Common.getPreferences().getBoolean(
                Preference.SaveLastUsedKeyFiles.toString(), true);
        ...
        if (fileNames.size() > 0) {
            ...
            if (keyFiles.size() > 0) {
                ...
                // Create reader.
                com.suntelecoms.mifare_nfc.MCReader reader = com.suntelecoms.mifare_nfc.Common.checkForTagAndCreateReader(this);
                if (reader == null) {
                    return;
                }
                ...
                com.suntelecoms.mifare_nfc.Common.setKeyMapRange(mFirstSector, mLastSector);
                // Init. GUI elements.
                mProgressStatus = -1;
     ...
     * calls {@link #keyMapCreated(com.suntelecoms.mifare_nfc.MCReader)}.
     * It also updates the progress bar in the UI thread.
     * @param reader A connected {@link com.suntelecoms.mifare_nfc.MCReader}.
     * @see #onCreateKeyMap(View)
     * @see #keyMapCreated(com.suntelecoms.mifare_nfc.MCReader)
     */
    private void createKeyMap(final com.suntelecoms.mifare_nfc.MCReader reader, final Context context) {
        new Thread(() -> {
            ...
            mHandler.post(() -> {
                ...
                if (mIsCreatingKeyMap && mProgressStatus != -1) {
                    ...
                    com.suntelecoms.mifare_nfc.Common.setKeyMap(null);
                    com.suntelecoms.mifare_nfc.Common.setKeyMapRange(-1, -1);
    ...
    /**
     * Triggered by {@link #createKeyMap(com.suntelecoms.mifare_nfc.MCReader, Context)}, this method
     * sets the result code to {@link Activity#RESULT_OK},
     * saves the created key map to
     * {@link com.suntelecoms.mifare_nfc.Common#setKeyMap(android.util.SparseArray)}
     * and finishes this Activity.
     * @param reader A {@link com.suntelecoms.mifare_nfc.MCReader}.
     * @see #createKeyMap(com.suntelecoms.mifare_nfc.MCReader, Context)
     * @see #onCreateKeyMap(View)
     */
    private void keyMapCreated(com.suntelecoms.mifare_nfc.MCReader reader) {
        ...
        if (reader.getKeyMap().size() == 0) {
            ...
            com.suntelecoms.mifare_nfc.Common.setKeyMap(reader.getKeyMap());
...
//            setResult(Activity.RESULT_OK, intent);
    ...
    public void onChangeSectorRange(View view) {
        ...
        int pad = com.suntelecoms.mifare_nfc.Common.dpToPx(10);
