...
import com.djamil.imagepicker.util.ExifDataCopier
import com.djamil.imagepicker.util.FileUriUtils
import com.djamil.imagepicker.util.FileUtil
import com.djamil.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<File, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.djamil.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(file)
    }
