...
import com.wakilytech.fluid_swipe.animation.Direction.LEFT
import com.wakilytech.fluid_swipe.animation.LeftEdgeController
import com.wakilytech.fluid_swipe.animation.RightEdgeController

/**
 * @Author Moustapha S. Dieme ( Djvmil_ ) on 10/4/20
 */

class FluidPager : ViewPager, ViewTreeObserver.OnDrawListener, ViewI {

    constructor(context: Context) : super(context)
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        buttonDrawableId = context.obtainStyledAttributes(attrs, R.styleable.FluidPager)
            .getResourceId(R.styleable.FluidPager_button_drawable, R.drawable.ic_button)
    }
